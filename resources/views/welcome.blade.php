    ...
    <section id="about" class="about">
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-lg-5 align-items-stretch video-box" style='background-image: url("{{asset('frontend')}}/img/about.jpg");'>
            ...
            <div class="tab-content">
              <div class="tab-pane active show" id="tab-1">
                <div class="row">
                  ...
                  <div class="col-lg-4 text-center order-1 order-lg-2">
                    <img src="{{asset('frontend')}}/img/specials-1.jpg" alt="" class="img-fluid">
                  </div>
                </div>
              </div>
              ...
              <div class="tab-pane" id="tab-5">
                <div class="row">
                  ...
                  <div class="col-lg-4 text-center order-1 order-lg-2">
                    <img src="{{asset('frontend')}}/img/specials-5.jpg" alt="" class="img-fluid">
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="container">
        ...
        <form action="{{route('reservation.reserve')}}" method="POST">
          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-md-6 form-group mt-3">
              <input type="number" class="form-control" name="person"  placeholder="# of person">
            </div>
          </div>
